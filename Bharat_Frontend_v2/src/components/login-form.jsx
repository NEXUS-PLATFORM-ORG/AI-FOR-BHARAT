      ...
      <Card className="bg-white border-slate-200 shadow-md">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription className="text-slate-500">
            Login to your account or continue with Google
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
            <div className="bg-red-50 border-l-[3px] border-red-500 p-3.5 mb-5 flex items-start gap-3">
              <Warning size={18} className="text-red-600 shrink-0 mt-0.5" weight="bold" />
              <p className="text-[13px] font-bold text-red-800 leading-snug">{error}</p>
            </div>
          )}
            ...
            <FieldGroup className="gap-5">
              ...
              <Field className="pt-2">
                ...
                <FieldDescription className="text-center mt-4 text-slate-500">
                  Don&apos;t have an account? <Link to="/signup" className="text-slate-900 hover:underline">Sign up</Link>
                </FieldDescription>
              </Field>
            </FieldGroup>
          </form>
